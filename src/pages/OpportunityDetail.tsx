...
export default function OpportunityDetail() {
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <button onClick={() => <button onClick={() => navigate("/saas/opportunities")} className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">} className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
